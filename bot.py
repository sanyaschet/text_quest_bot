...
Предоставьте источник происхождения зафиксированного следа. Система принимает только идентификатор места, с которым он совпадает. При успешном совпадении будет выдан фрагмент восстановленного сообщения.""",
